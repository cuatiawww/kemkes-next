...
const defaultHealthEvents: HealthEvent[] = [
...
/**
 * Sidebar Kalender Kesehatan yang reusable
 * @param title - Judul section (default: "KALENDER KESEHATAN")
 * @param description - Deskripsi section
 * @param events - Array event kesehatan
 * @param className - Custom className
 */
export default function CalendarSidebar({
  title = "KALENDER KESEHATAN",
  description = "Jadwal dan peringatan hari-hari penting kesehatan nasional dan internasional yang diperingati oleh Kementerian Kesehatan RI.",
  events = defaultHealthEvents,
  className = "",
