...
export default function SocialMediaSection() {
  ...
  useEffect(() => {
    ...
    if (
      currentPlatform.name === "Facebook" ||
      currentPlatform.name === "Snack Video"
    ) {
      return;
    }
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 text-xs md:text-sm mb-3 md:mb-4">
        Ikuti update terkini dari berbagai platform media sosial resmi
          ...
          <div className="flex items-center justify-center gap-2 md:gap-2.5 mb-3 md:mb-4 overflow-x-auto pb-1 p-4">
            {socialMediaPlatforms.map((platform, index) => (
              <button
                ...
                style={{
                  backgroundColor:
                    activePlatform === index ? platform.color : undefined,
                }}
                title={platform.name}
              >
                <Image
